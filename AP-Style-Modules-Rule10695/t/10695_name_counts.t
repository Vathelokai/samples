...
my $input = read_file('t/inputs/10695_name_counts.input');

# Ensure that $input isn't empty
isnt($input, undef, "Finding 10695_name_counts.input");
...
my $module = AP::Style::Modules::Rule10695->new(
			...
			destination => {
				       off => 1,
				       #logfile => 't\\10695_name_counts.log',
...
######################################
my $output = read_file('t/outputs/10695_name_counts.output');

isnt($output, undef, "Finding 10695_name_counts.output");
