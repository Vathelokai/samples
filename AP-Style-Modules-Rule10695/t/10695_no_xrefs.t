...
my $input = read_file('t/inputs/10695_no_xrefs.input');

# Ensure that $input isn't empty
isnt($input, undef, "Finding 10695_no_xrefs.input");
...
######################################
my $output = read_file('t/outputs/10695_no_xrefs.output');

isnt($output, undef, "Finding 10695_no_xrefs.output");
