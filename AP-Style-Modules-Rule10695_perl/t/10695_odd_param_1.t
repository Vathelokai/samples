...
my $input = read_file('t/inputs/10695_odd_param_test.input');

# Ensure that $input isn't empty
isnt($input, undef, "Finding 10695_odd_param_test.input");
...
my $params = {
    author_count_first  => 'all',
    author_count_other  => 'all',
    truncate_text       => '### FAIL ###',
};
...
my $module = AP::Style::Modules::Rule10695->new(
			...
			destination => {
				       off => 1,
				       #logfile => 't\\10695_odd_param_1.log',
...
######################################
my $output = read_file('t/outputs/10695_odd_param_1.output');

isnt($output, undef, "Finding 10695_odd_param_1.output");
