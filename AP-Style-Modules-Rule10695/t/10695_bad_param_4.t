...
my $module = AP::Style::Modules::Rule10695->new(
			...
			destination => {
				       off => 1,
				       #logfile => 't\\10695_bad_param_4.log',
...
######################################
my $output = read_file('t/outputs/10695_bad_param_4.output');

isnt($output, undef, "Finding 10695_bad_param_4.output");
