...
my $input = read_file('t/inputs/10695_minimal_sample.input');

# Ensure that $input isn't empty
isnt($input, undef, "Finding 10695_minimal_sample.input");
...
my $module = AP::Style::Modules::Rule10695->new(
			...
			destination => {
				       off => 1,
				       #logfile => 't\\10695_minimal_sample.log',
...
######################################
my $output = read_file('t/outputs/10695_minimal_sample.output');

isnt($output, undef, "Finding 10695_minimal_sample.output");
