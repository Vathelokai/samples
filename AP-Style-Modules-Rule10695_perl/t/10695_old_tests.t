...
my $input = read_file('t/inputs/10695_old_tests.input');

# Ensure that $input isn't empty
isnt($input, undef, "Finding 10695_old_tests.input");
...
my $params = {
    author_count_first  => '3',
    author_count_other  => '3',
...
######################################
my $output = read_file('t/outputs/10695_old_tests.output');

isnt($output, undef, "Finding 10695_old_tests.output");
