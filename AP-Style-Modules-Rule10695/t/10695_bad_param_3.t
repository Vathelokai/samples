...
my $input = read_file('t/inputs/10695_bad_param_test.input');

# Ensure that $input isn't empty
isnt($input, undef, "Finding 10695_bad_param_test.input");
...
my $module = AP::Style::Modules::Rule10695->new(
			...
			destination => {
				       off => 1,
				       #logfile => 't\\10695_bad_param_3.log',
...
######################################
my $output = read_file('t/outputs/10695_bad_param_3.output');

isnt($output, undef, "Finding 10695_bad_param_3.output");
